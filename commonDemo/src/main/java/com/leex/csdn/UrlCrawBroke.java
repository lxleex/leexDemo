...
public class UrlCrawBroke {
    ...
    static String userId = "mp";// 这里填入主页名称：例如主业为 https://hanquan.blog.csdn.net/ 则填入 hanquan 即可
    static final String homeUrl = "https://blog.csdn.net/qq_28623375?type=lately";
